...
const roomDatabase = [
	...
	{ id: "reactor_light", name: "Micro Reactor", type: "core", core_category: "reactor", cost: 10, width: 130, height: 180, max_connections: 2, max_hp: 4, is_mannable: true, ammo: 0 },
	{ id: "reactor", name: "Reactor", type: "core", core_category: "reactor", cost: 30, width: 130, height: 180, max_connections: 3, max_hp: 6, is_mannable: true, ammo: 0 },
	{ id: "reactor_heavy", name: "Heavy Reactor", type: "core", core_category: "reactor", cost: 60, width: 130, height: 180, max_connections: 4, max_hp: 8, is_mannable: true, ammo: 0 },
 	...
 	{ id: "point_def", name: "Point Defense", type: "auxiliary", cost: 10, width: 130, height: 180, max_connections: 3, max_hp: 2, is_mannable: false, ammo: 0 },
	...
	{ id: "shield_generator", name: "Shield Generator", type: "auxiliary", cost: 15, width: 130, height: 180, max_connections: 2, max_hp: 2, is_mannable: true, ammo: 0 },

	{ id: "atomic_laser", name: "Atomic Laser", type: "weapon", cost: 15, width: 130, height: 180, max_connections: 3, max_hp: 2, is_mannable: true, ammo: 0, has_arc: true },
	...
	{ id: "microwave", name: "Microwave Gun", type: "weapon", cost: 15, width: 130, height: 180, max_connections: 3, max_hp: 2, is_mannable: true, ammo: 0, has_arc: true },
